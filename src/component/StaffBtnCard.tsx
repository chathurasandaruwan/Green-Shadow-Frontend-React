export function StaffBtnCard(props:any) {
    return (
        <div className="col-md-3">
            <div className="form-group">
                <div id={props.id} className="custCard work" onClick={() => props.action(props.type)}>
                    <div className="img-section">
                        <svg xmlns="http://www.w3.org/2000/svg" height="77" width="76">
                            <path fillRule="nonzero" fill="#3F9CBB"
                    ...
                    <div className={props.descStyle}>
                        ...
                        <div className="card-time"><i className={props.iconStyle} aria-hidden="true"></i></div>
                    </div>
                </div>
            </div>
        </div>
